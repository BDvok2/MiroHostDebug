...
if ( $featured_images_only === 'yes' ) {
	$portfolio_list_image = 0;
}
...
if ( $has_image ) {
	...
	<div class="qodef-e-media-image">
		<a itemprop="url" href="<?php the_permalink(); ?>">
			<?php echo techlink_core_get_list_shortcode_item_image( $image_dimension, $portfolio_list_image, $custom_image_width, $custom_image_height ); ?>
		</a>
	</div>
<?php } ?>
