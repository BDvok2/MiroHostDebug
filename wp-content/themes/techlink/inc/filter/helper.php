...
if ( ! function_exists( 'techlink_get_filter_items' ) ) {
	/**
	 ...
	 * @return array
	 */
	function techlink_get_filter_items( $params ) {
		...
		return apply_filters( 'techlink_filter_get_filter_items', $items, $params );
	}
}
