...
if ( ! function_exists( 'techlink_core_add_material_icons_to_collection' ) ) {
	/**
	 ...
	 * @return array
	 */
	function techlink_core_add_material_icons_to_collection( $icons ) {
		$icons[] = 'TechLinkCoreMaterialIconsPack';
		
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'techlink_core_add_material_icons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class TechLinkCoreMaterialIconsPack extends QodeFrameworkIconPack {
