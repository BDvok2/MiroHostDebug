...
if ( ! function_exists( 'techlink_core_mobile_header_menu_options' ) ) {
	/**
	 * Function that add general options for this module
	 *
	 * @param object $page
	 */
	function techlink_core_mobile_header_menu_options( $page ) {
		...
		if ( $page ) {
			$mobile_menu_tab = $page->add_tab_element(
				array(
					...
					'icon'  => 'fa fa-cog',
					'title' => esc_html__( 'Mobile Menu Settings', 'techlink-core' )
				)
			);
			...
			$typography_section = $mobile_menu_tab->add_section_element(
				array(
					...
					'title'      => esc_html__( 'Mobile Menu Typography', 'techlink-core' ),
					'dependency' => array(
						'hide' => array(
							'qodef_mobile_header_layout' => array(
								'values'        => techlink_core_dependency_for_mobile_menu_typography_options(),
	...
	add_action( 'techlink_core_action_after_mobile_header_options_map', 'techlink_core_mobile_header_menu_options' );
}