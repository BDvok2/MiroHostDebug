...
if ( ! function_exists( 'techlink_core_add_team_single_sidebar_meta_boxes' ) ) {
	/**
	 * Function that add sidebar meta boxes for team single module
	 */
	function techlink_core_add_team_single_sidebar_meta_boxes( $page, $has_single ) {
	...
	add_action( 'techlink_core_action_after_team_meta_box_map', 'techlink_core_add_team_single_sidebar_meta_boxes', 10, 2 );
}