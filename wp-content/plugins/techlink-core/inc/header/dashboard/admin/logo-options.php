...
if ( ! function_exists( 'techlink_core_add_logo_options' ) ) {
	/**
	 * Function that add general options for this module
	 */
	function techlink_core_add_logo_options() {
		...
		$page = $qode_framework->add_options_page(
			array(
				...
				'slug'        => 'logo',
				'icon'        => 'fa fa-cog',
				'title'       => esc_html__( 'Logo', 'techlink-core' ),
				'description' => esc_html__( 'Global Logo Options', 'techlink-core' ),
				'layout'      => 'tabbed'
			)
		);
		...
		if ( $page ) {
			...
			$header_tab = $page->add_tab_element(
				array(
					...
					'description' => esc_html__( 'Set options for initial headers', 'techlink-core' )
				)
			);
			...
			do_action( 'techlink_core_action_after_header_logo_options_map', $page, $header_tab );
		}
	}

	add_action( 'techlink_core_action_default_options_init', 'techlink_core_add_logo_options', techlink_core_get_admin_options_map_position( 'logo' ) );
}