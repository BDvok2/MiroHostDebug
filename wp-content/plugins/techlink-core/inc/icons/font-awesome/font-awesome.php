...
if ( ! function_exists( 'techlink_core_add_font_awesome_to_collection' ) ) {
	/**
	 ...
	 * @return array
	 */
	function techlink_core_add_font_awesome_to_collection( $icons ) {
		$icons[] = 'TechLinkCoreFontAwesomePack';
		
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'techlink_core_add_font_awesome_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class TechLinkCoreFontAwesomePack extends QodeFrameworkIconPack {
		...
		public function get_style_url() {
			return TECHLINK_CORE_INC_URL_PATH . '/icons/' . $this->get_base() . '/assets/css/all.min.css';
		}
		...
		function get_new_icons_list() {
			...
			if ( file_exists( TECHLINK_CORE_INC_PATH . '/icons/' . $this->get_base() . '/icons.json' ) ) {
				$new_icons = @file_get_contents( TECHLINK_CORE_INC_URL_PATH . '/icons/' . $this->get_base() . '/icons.json' );
