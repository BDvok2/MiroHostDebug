...
if ( ! class_exists( 'TechLinkCoreWooCommerceYITHWishlist' ) ) {
	class TechLinkCoreWooCommerceYITHWishlist {
		...
		function change_templates_position() {
			...
			add_action( 'techlink_action_product_list_item_additional_image_content', 'techlink_core_get_yith_wishlist_shortcode' );
			add_action( 'techlink_core_action_product_list_item_additional_image_content', 'techlink_core_get_yith_wishlist_shortcode' );
		}
	...
	TechLinkCoreWooCommerceYITHWishlist::get_instance();
}