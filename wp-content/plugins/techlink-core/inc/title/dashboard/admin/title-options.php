...
if ( ! function_exists( 'techlink_core_add_page_title_options' ) ) {
	/**
	 * Function that add general options for this module
	 */
	function techlink_core_add_page_title_options() {
		...
		$page = $qode_framework->add_options_page(
			array(
				...
				'description' => esc_html__( 'Global Title Options', 'techlink-core' )
			)
		);
		...
		if ( $page ) {
			...
			$page_title_section->add_field_element(
				array(
					...
					'options'       => apply_filters( 'techlink_core_filter_title_layout_options', array() ),
			...
			do_action( 'techlink_core_action_after_page_title_options_map', $page_title_section );
		}
	}

	add_action( 'techlink_core_action_default_options_init', 'techlink_core_add_page_title_options', techlink_core_get_admin_options_map_position( 'title' ) );
}
