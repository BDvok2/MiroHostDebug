(function ( $ ) {
	...
	var qodefInlinePageStyle = {
		init: function () {
			this.holder = $( '#techlink-core-page-inline-style' );
...
(function ($) {
	...
	var qodefSpinner = {
		init: function (isEditMode) {
			this.holder = $('#qodef-page-spinner:not(.qodef-layout--techlink)');
...
(function ($) {
				...
				$wishlistLink.each(function () {
					...
					$thisWishlistLink.off().on('click', function (e) {
						...
						if (qodefCore.body.hasClass('logged-in')) {
								...
								$.ajax({
									...
									success: function (response) {
										...
										if (response.status === 'success') {
											...
											$(document).trigger('techlink_core_wishlist_item_is_added', [itemID, response.data.user_id]);
										} else {
											$responseMessage.html(response.message).addClass('qodef--show').fadeIn(200);
										}
							...
							// Trigger event.
							$(document.body).trigger('techlink_membership_trigger_login_modal');
						}
					});
				});
			}
	...
	$(document).on('techlink_core_wishlist_item_is_removed', function (e, removedItemID) {
		var $wishlistLink = $('.qodef-wishlist .qodef-m-link');
...
(function ($) {
	...
	qodefCore.shortcodes.techlink_core_accordion = {};
	...
	qodefCore.shortcodes.techlink_core_accordion.qodefAccordion = qodefAccordion;

})(jQuery);
(function ($) {
    "use strict";

	qodefCore.shortcodes.techlink_core_banner = {};

	$( window ).on(
		'load',
		function () {
			qodefCore.shortcodes.techlink_core_banner.qodefButton = qodefCore.qodefButton;
		}
	);
...
(function ($) {
	...
	qodefCore.shortcodes.techlink_core_button = {};
	...
	qodefCore.qodefButton = qodefButton;
	qodefCore.shortcodes.techlink_core_button.qodefButton = qodefButton;
...
(function ($) {
	...
	qodefCore.shortcodes.techlink_core_cards_gallery = {};
	...
	qodefCore.shortcodes.techlink_core_cards_gallery.qodefCardsGallery  = qodefCardsGallery;
	
})(jQuery);
(function ($) {
	"use strict";

	qodefCore.shortcodes.techlink_core_countdown = {};
	...
	qodefCore.shortcodes.techlink_core_countdown.qodefCountdown  = qodefCountdown;
...
(function ($) {
	...
	qodefCore.shortcodes.techlink_core_counter = {};
	...
	qodefCore.shortcodes.techlink_core_counter.qodefCounter  = qodefCounter;
...
(function ($) {
	...
	qodefCore.shortcodes.techlink_core_frame_slider = {};
	...
	qodefCore.shortcodes.techlink_core_frame_slider.qodefFrameSlider  = qodefFrameSlider;
...
(function ($) {
	...
	qodefCore.shortcodes.techlink_core_google_map = {};
	...
	qodefCore.shortcodes.techlink_core_google_map.qodefGoogleMap = qodefGoogleMap;
	
})(jQuery);
(function ($) {
    "use strict";

	qodefCore.shortcodes.techlink_core_icon = {};
	...
	qodefCore.shortcodes.techlink_core_icon.qodefIcon = qodefIcon;
...
(function ($) {
	...
	qodefCore.shortcodes.techlink_core_image_with_text = {};
    qodefCore.shortcodes.techlink_core_image_with_text.qodefMagnificPopup = qodef.qodefMagnificPopup;

})(jQuery);
(function ($) {
    "use strict";
	
	qodefCore.shortcodes.techlink_core_item_showcase = {};
	...
	qodefCore.shortcodes.techlink_core_item_showcase.qodefItemShowcaseList = qodefItemShowcaseList;
...
(function ($) {
	...
	qodefCore.shortcodes.techlink_core_pricing_table = {};
	qodefCore.shortcodes.techlink_core_pricing_table.qodefButton = qodefCore.shortcodes.techlink_core_button.qodefButton;
...
(function ($) {
    ...
    qodefCore.shortcodes.techlink_core_progress_bar = {};
    ...
    var qodefProgressBar = {
        ...
        initLineBar: function ($container, data) {
            $container
                ...
                .find('.percentCount').css({
                    'color': data.textColor
                });

            $container.addClass('qodef--show-percentage');
        },
    ...
    qodefCore.shortcodes.techlink_core_progress_bar.qodefProgressBar = qodefProgressBar;
...
(function ($) {
	...
	qodefCore.shortcodes.techlink_core_tabs = {};
	...
	qodefCore.shortcodes.techlink_core_tabs.qodefTabs = qodefTabs;
...
(function ($) {
	...
	qodefCore.shortcodes.techlink_vertical_split_slider = {};
	...
	qodefCore.shortcodes.techlink_vertical_split_slider.qodefVerticalSplitSlider = qodefVerticalSplitSlider;

})(jQuery);
(function ($) {
    "use strict";

	qodefCore.shortcodes.techlink_core_video_button = {};
    qodefCore.shortcodes.techlink_core_video_button.qodefMagnificPopup = qodef.qodefMagnificPopup;
...
(function ( $ ) {
	...
	var qodefStickySidebar = {
		init: function () {
			var info = $( '.widget_techlink_core_sticky_sidebar' );
...
(function ($) {
	...
	var shortcode = 'techlink_core_blog_parallax';
	...
	var qodefSearchFullscreen = {
        ...
        openFullscreen: function($searchHolder){
            ...
            setTimeout(function () {
                ...
                qodefSearchFullscreen.animateLine($searchHolder);
            }, 900);
        ...
        animateLine: function ( $searchHolder ) {
	        var $input  = $searchHolder.find('.qodef-m-form-field'),
	            $line   = $searchHolder.find('.qodef-m-form-animated-line'),
                $hidden = $searchHolder.find('.qodef-m-hidden');

            $input.on('keyup', function () {
                $hidden.html($input.val());

                if ( $input.val().length === 0 ) {
                    $line.css('width', 388);
                } else {
                    $line.css('width', $hidden.width());
                }
            });
        }
    };
...
(function ($) {
				...
				$.ajax({
					...
					success: function (response) {
						if (response.status === 'success') {
							...
							$(document).trigger('techlink_core_wishlist_item_is_removed', [removeItemID]);
						} else {
	...
	$(document).on('techlink_core_wishlist_item_is_added', function (e, addedItemID, addedUserID) {
		var $holder = $('.qodef-wishlist-dropdown');
...
(function ($) {
	...
	qodefCore.shortcodes.techlink_core_instagram_list = {};
	...
	qodefCore.shortcodes.techlink_core_instagram_list.qodefInstagram = qodefInstagram;
	qodefCore.shortcodes.techlink_core_instagram_list.qodefSwiper = qodef.qodefSwiper;
...
(function ($) {
	...
	qodefCore.shortcodes.techlink_core_product_categories_list = {};
	qodefCore.shortcodes.techlink_core_product_categories_list.qodefMasonryLayout = qodef.qodefMasonryLayout;
	qodefCore.shortcodes.techlink_core_product_categories_list.qodefSwiper = qodef.qodefSwiper;

})(jQuery);
(function ($) {
	"use strict";
	
	var shortcode = 'techlink_core_product_list';
...
(function ($) {
	...
	qodefCore.shortcodes.techlink_core_clients_list = {};
	qodefCore.shortcodes.techlink_core_clients_list.qodefSwiper = qodef.qodefSwiper;
})(jQuery);
(function ($) {
	"use strict";
...
(function ($) {
	...
	var shortcode = 'techlink_core_team_list';
...
(function ($) {
    "use strict";
	qodefCore.shortcodes.techlink_core_testimonials_list = {};
	qodefCore.shortcodes.techlink_core_testimonials_list.qodefSwiper = qodef.qodefSwiper;
...
(function ( $ ) {
	...
	$( document ).on(
		'techlink_trigger_get_new_posts',
		function () {
			qodefInfoFollow.init();
		}
	);
	...
	var qodefInfoFollow = {
		init: function () {
			...
			if ( $gallery.length ) {
				qodefCore.body.append( '<div class="qodef-follow-info-holder"><div class="qodef-follow-info-inner"><span class="qodef-follow-info-category"></span><span class="qodef-follow-info-title"></span></div></div>' );
	...
	qodefCore.shortcodes.techlink_core_portfolio_list.qodefInfoFollow = qodefInfoFollow;
