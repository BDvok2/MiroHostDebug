...
if ( ! function_exists( 'techlink_core_add_ionicons_to_collection' ) ) {
	/**
	 ...
	 * @return array
	 */
	function techlink_core_add_ionicons_to_collection( $icons ) {
		$icons[] = 'TechLinkCoreIonIconsPack';
		
		return $icons;
	}
	
	add_filter( 'qode_framework_filter_add_icon', 'techlink_core_add_ionicons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class TechLinkCoreIonIconsPack extends QodeFrameworkIconPack {
