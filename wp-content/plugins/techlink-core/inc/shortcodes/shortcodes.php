...
if ( ! class_exists( 'TechLinkCoreShortcodes' ) ) {
	class TechLinkCoreShortcodes {
		...
		function init() {
			...
			include_once TECHLINK_CORE_SHORTCODES_PATH . '/dashboard/customizer/shortcodes-customizer-options.php';
		}
		...
		function include_shortcode_classes() {
			include_once TECHLINK_CORE_SHORTCODES_PATH . '/shortcode.php';
			include_once TECHLINK_CORE_SHORTCODES_PATH . '/list-shortcode.php';
		}
		...
		function register_shortcodes() {
			...
			$shortcodes     = apply_filters( 'techlink_core_filter_register_shortcodes', $shortcodes = array() );
	...
	TechLinkCoreShortcodes::get_instance();
}