<article <?php post_class( array( 'qodef-blog-item',  ) ); ?>>
	<div class="qodef-e-inner">
		<?php
		// Include post media
		techlink_core_template_part( 'blog/shortcodes/blog-showcase', 'templates/post-info/media', '', $params );
		?>
		<div class="qodef-e-content">
			...
			<div class="qodef-e-text">
				...
				techlink_core_theme_template_part( 'blog', 'templates/parts/post-info/excerpt', '', $params );
