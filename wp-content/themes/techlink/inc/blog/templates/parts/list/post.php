	...
	<div class="qodef-e-inner">
		...
		<div class="qodef-e-content">
			...
			<div class="qodef-e-text">
				<?php
				// Include post title
				techlink_template_part( 'blog', 'templates/parts/post-info/title', '', array( 'title_tag' => 'h2' ) );

				// Include post excerpt
				techlink_template_part( 'blog', 'templates/parts/post-info/excerpt' );
			...
			<div class="qodef-e-info qodef-info--bottom">
				<div class="qodef-e-info-left">
					...
					techlink_template_part( 'blog', 'templates/parts/post-info/read-more' );
					?>
				</div>
			</div>
		</div>
