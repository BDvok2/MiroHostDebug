...
if ( ! function_exists( 'techlink_core_add_h4_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 *
	 * @param object $page
	 */
	function techlink_core_add_h4_typography_options( $page ) {
		...
		if ( $page ) {
			$h4_tab = $page->add_tab_element(
				array(
					'name'        => 'tab-h4',
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'H4 Typography', 'techlink-core' ),
					'description' => esc_html__( 'Set values for Heading 4 HTML element', 'techlink-core' )
				)
			);
			...
			$h4_typography_section = $h4_tab->add_section_element(
				array(
					...
					'title' => esc_html__( 'General Typography', 'techlink-core' )
				)
			);
			...
			$h4_typography_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Margin Top', 'techlink-core' ),
					'args'       => array(
						'col_width' => 3
					)
				)
			...
			$h4_typography_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Margin Bottom', 'techlink-core' ),
					'args'       => array(
						'col_width' => 3
					)
				)
            ...
            $h4_1366_typography_section = $h4_tab->add_section_element(
                array(
                    ...
                    'title' => esc_html__( 'Responsive 1366 Typography', 'techlink-core' )
                )
            );
			...
			$h4_1024_typography_section = $h4_tab->add_section_element(
				array(
					...
					'title' => esc_html__( 'Responsive 1024 Typography', 'techlink-core' )
				)
			);
			...
			$h4_768_typography_section = $h4_tab->add_section_element(
				array(
					...
					'title' => esc_html__( 'Responsive 768 Typography', 'techlink-core' )
				)
			);
			...
			$h4_680_typography_section = $h4_tab->add_section_element(
				array(
					...
					'title' => esc_html__( 'Responsive 680 Typography', 'techlink-core' )
				)
			);
	...
	add_action( 'techlink_core_action_after_typography_options_map', 'techlink_core_add_h4_typography_options' );
}