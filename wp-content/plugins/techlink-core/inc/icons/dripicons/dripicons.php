...
if ( ! function_exists( 'techlink_core_add_dripicons_to_collection' ) ) {
	/**
	 ...
	 * @return array
	 */
	function techlink_core_add_dripicons_to_collection( $icons ) {
		$icons[] = 'TechLinkCoreDripiconsIconPack';
		
		return $icons;
	}

	add_filter( 'qode_framework_filter_add_icon', 'techlink_core_add_dripicons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class TechLinkCoreDripiconsIconPack extends QodeFrameworkIconPack {
