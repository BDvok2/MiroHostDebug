<div class="qodef-m-inner">
	<div class="qodef-m-weather">
		...
		<?php techlink_core_template_part( 'widgets/weather', 'templates/parts/temperature', '', $params ); ?>
	</div>
	<div class="qodef-m-weather-info qodef-e">
		...
		<p class="qodef-e-humidity">
			<?php echo sprintf( '%s%s%s', esc_html__( 'Humidity:', 'techlink-core' ), esc_html( $today_humidity ), esc_html__( '%', 'techlink-core' ) ); ?>
		</p>
		<p class="qodef-e-wind">
			<?php echo sprintf( '%s%s%s', esc_html__( 'Wind:', 'techlink-core' ), esc_html( $today_wind_speed ), esc_html( $wind_unit ) ); ?>
		</p>
		<p class="qodef-e-temperature qodef--high-low">
			<span class="qodef-e-temperature-low"><?php
				echo sprintf( '%s %s%s%s',
					esc_html__( 'L', 'techlink-core' ),
					esc_html( $today_low ),
					'<sup>°</sup>',
					esc_html( $temp_unit )
				);
