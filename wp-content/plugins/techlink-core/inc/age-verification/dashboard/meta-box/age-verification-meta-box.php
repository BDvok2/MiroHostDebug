...
if ( ! function_exists( 'techlink_core_add_age_verification_single_meta_box' ) ) {
	/**
	 * Function that add general meta box options for this module
	 *
	 * @param object $page
	 */
	function techlink_core_add_age_verification_single_meta_box( $page ) {
		...
		if ( $page ) {
			...
			$age_verification_tab = $page->add_tab_element(
				array(
					...
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'Age Verification Settings', 'techlink-core' ),
			...
			do_action( 'techlink_core_action_after_page_age_verification_meta_box_map', $age_verification_tab );
		}
	}
	
	add_action( 'techlink_core_action_after_general_meta_box_map', 'techlink_core_add_age_verification_single_meta_box' );
}