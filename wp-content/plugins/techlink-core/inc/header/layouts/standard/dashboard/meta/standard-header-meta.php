...
if ( ! function_exists( 'techlink_core_add_standard_header_meta' ) ) {
	/**
	 * Function that add additional header layout meta box options
	 *
	 * @param object $page
	 */
	function techlink_core_add_standard_header_meta( $page ) {
	...
	add_action( 'techlink_core_action_after_page_header_meta_map', 'techlink_core_add_standard_header_meta' );
}
