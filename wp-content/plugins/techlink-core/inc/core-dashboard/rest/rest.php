...
if ( ! class_exists( 'TechLinkCoreDashboardRestAPI' ) ) {
	 ...
	 */
	class TechLinkCoreDashboardRestAPI {
		...
		public function __construct() {
			...
			add_filter( 'techlink_core_filter_dashboard_js_global_variables', array( $this, 'localize_script' ) );
	...
	TechLinkCoreDashboardRestAPI::get_instance();
}
