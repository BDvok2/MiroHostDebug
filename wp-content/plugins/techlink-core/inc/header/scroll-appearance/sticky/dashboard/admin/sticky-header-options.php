...
if ( ! function_exists( 'techlink_core_add_sticky_header_options' ) ) {
	/**
	 ...
	 */
	function techlink_core_add_sticky_header_options( $page, $section ) {
	...
	add_action( 'techlink_core_action_after_header_scroll_appearance_options_map', 'techlink_core_add_sticky_header_options', 10, 2 );
}

if ( ! function_exists( 'techlink_core_add_sticky_header_logo_options' ) ) {
	/**
	 ...
	 */
	function techlink_core_add_sticky_header_logo_options( $page, $header_tab ) {
	...
	add_action( 'techlink_core_action_after_header_logo_options_map', 'techlink_core_add_sticky_header_logo_options', 10, 2 );
}