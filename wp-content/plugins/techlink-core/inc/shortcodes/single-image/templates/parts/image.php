<?php if ( ! empty( $image_params['image_id'] ) ) { ?>
	<div class="qodef-m-image" <?php qode_framework_inline_style( $holder_styles ); ?>>
	...
	<?php if ( ! empty( $decoration ) ) { ?>
		<div class="qodef-m-decoration">
			<?php techlink_core_template_part( 'shortcodes/single-image', 'templates/parts/decoration', $decoration, $params ); ?>
		</div>
	<?php } ?>
<?php } ?>