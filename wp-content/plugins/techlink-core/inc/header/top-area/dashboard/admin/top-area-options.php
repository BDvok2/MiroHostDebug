...
if ( ! function_exists( 'techlink_core_add_top_area_options' ) ) {
	/**
	 ...
	 */
	function techlink_core_add_top_area_options( $page, $general_header_tab ) {
		...
		$top_area_section = $general_header_tab->add_section_element(
			array(
				...
				'description' => esc_html__( 'Options related to top area', 'techlink-core' ),
				'dependency'  => array(
					'hide' => array(
	...
	add_action( 'techlink_core_action_after_header_options_map', 'techlink_core_add_top_area_options', 20, 2 );
}